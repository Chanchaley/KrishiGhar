...
public class MarketValue extends Fragment {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        MarketValueModel marketValue = new MarketValueModel();
                        marketValue.setId(jsonObject.getString("id"));
                        marketValue.setName(jsonObject.getString("name"));
                        marketValue.setUnit(jsonObject.getString("unit"));
                        marketValue.setThokAverage(jsonObject.getString("thokAverage"));
                        marketValue.setKhudraAverage(jsonObject.getString("khudraAverage"));
                        marketValue.setOnDate(jsonObject.getString("onDate"));
                        marketValueList.add(marketValue);

                    }
                    markertValueAdapter.notifyDataSetChanged();
